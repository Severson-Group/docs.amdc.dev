...
NOTE: if any mistakes are found in this document, **make sure to update the [REV F Vivado constraint file](https://github.com/Severson-Group/AMDC-Firmware/blob/develop/hw/constraints_amdc_revf.xdc)!!!**
