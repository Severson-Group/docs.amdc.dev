...
To learn more about how to enable sensors and how to configure triggering, please follow the [Timing & Sensors tutorial](/getting-started/tutorials/timing-manager/index.md).
