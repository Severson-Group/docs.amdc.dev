...
Each tag is a snapshot of the docs at one point in time, representing the most up to date documentation for the firmware revision it is tagged as. 
...
```
For building the documentation locally, `make local` can be used to only build the files on your computer, instead of building the entire verison tree. This allows you to test changes without making commits.
