...
An example tutorial, [Tutorial: Autogen](../../tutorials/autogen/), is provided to demonstrate the Simulink Autogen workflow for control implementation and its integration with the AMDC.
